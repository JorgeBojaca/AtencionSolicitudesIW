...
/**
 * DAO Interfaz que define los metodos que va a proveer la clase TipoSolicitud.
 * 
 * @author Diana Ciro
...
public interface TipoSolicitudDao {
	...
	/**
	 * Obtener la lista de los tipos de solicitud almacenados en la tabla
	 * TipoSolicitud de la base de datos.
	 * 
	...
	/**
	 * Obtener el tipo Solicitud que corresponda al identificador ingresado como
	 * parámetro.
	 * 
	 * @param id
